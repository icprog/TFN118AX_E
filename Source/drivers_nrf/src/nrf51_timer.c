...
{
	if (TIMERx == NRF_TIMER1)
	{
		TIMERx->TASKS_STOP 	= 1;
		TIMERx->INTENSET = (TIMER_INTENSET_COMPARE0_Disabled << TIMER_INTENSET_COMPARE0_Pos)
								| (TIMER_INTENSET_COMPARE1_Disabled << TIMER_INTENSET_COMPARE1_Pos)
								| (TIMER_INTENSET_COMPARE2_Disabled << TIMER_INTENSET_COMPARE2_Pos)
								| (TIMER_INTENSET_COMPARE3_Disabled << TIMER_INTENSET_COMPARE3_Pos);	
